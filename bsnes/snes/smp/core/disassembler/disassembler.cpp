...
void SMPcore::disassemble_opcode(char *output, uint16 addr) {
  ...
  switch(op) {
    ...
    case 0x03: sprintf(t, "bbs0  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0x10: sprintf(t, "bpl   $%.4x", relb(op0, 2, addr));                  break;
    case 0x11: sprintf(t, "tcall 1");                                    break;
    case 0x12: sprintf(t, "clr0  $%.3x", opdp0);                         break;
    case 0x13: sprintf(t, "bbc0  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0x23: sprintf(t, "bbs1  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0x2e: sprintf(t, "cbne  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    case 0x2f: sprintf(t, "bra   $%.4x", relb(op0, 2, addr));                  break;
    case 0x30: sprintf(t, "bmi   $%.4x", relb(op0, 2, addr));                  break;
    case 0x31: sprintf(t, "tcall 3");                                    break;
    case 0x32: sprintf(t, "clr1  $%.3x", opdp0);                         break;
    case 0x33: sprintf(t, "bbc1  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0x43: sprintf(t, "bbs2  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0x50: sprintf(t, "bvc   $%.4x", relb(op0, 2, addr));                  break;
    case 0x51: sprintf(t, "tcall 5");                                    break;
    case 0x52: sprintf(t, "clr2  $%.3x", opdp0);                         break;
    case 0x53: sprintf(t, "bbc2  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0x63: sprintf(t, "bbs3  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0x6e: sprintf(t, "dbnz  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    case 0x6f: sprintf(t, "ret");                                        break;
    case 0x70: sprintf(t, "bvs   $%.4x", relb(op0, 2, addr));                  break;
    case 0x71: sprintf(t, "tcall 7");                                    break;
    case 0x72: sprintf(t, "clr3  $%.3x", opdp0);                         break;
    case 0x73: sprintf(t, "bbc3  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0x83: sprintf(t, "bbs4  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0x90: sprintf(t, "bcc   $%.4x", relb(op0, 2, addr));                  break;
    case 0x91: sprintf(t, "tcall 9");                                    break;
    case 0x92: sprintf(t, "clr4  $%.3x", opdp0);                         break;
    case 0x93: sprintf(t, "bbc4  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0xa3: sprintf(t, "bbs5  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0xb0: sprintf(t, "bcs   $%.4x", relb(op0, 2, addr));                  break;
    case 0xb1: sprintf(t, "tcall 11");                                   break;
    case 0xb2: sprintf(t, "clr5  $%.3x", opdp0);                         break;
    case 0xb3: sprintf(t, "bbc5  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0xc3: sprintf(t, "bbs6  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0xd0: sprintf(t, "bne   $%.4x", relb(op0, 2, addr));                  break;
    case 0xd1: sprintf(t, "tcall 13");                                   break;
    case 0xd2: sprintf(t, "clr6  $%.3x", opdp0);                         break;
    case 0xd3: sprintf(t, "bbc6  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0xde: sprintf(t, "cbne  $%.3x+x,$%.4x", opdp0, relb(op1, 3, addr));   break;
    ...
    case 0xe3: sprintf(t, "bbs7  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0xf0: sprintf(t, "beq   $%.4x", relb(op0, 2, addr));                  break;
    case 0xf1: sprintf(t, "tcall 15");                                   break;
    case 0xf2: sprintf(t, "clr7  $%.3x", opdp0);                         break;
    case 0xf3: sprintf(t, "bbc7  $%.3x,$%.4x", opdp0, relb(op1, 3, addr));     break;
    ...
    case 0xfe: sprintf(t, "dbnz  y,$%.4x", relb(op0, 2, addr));                break;
