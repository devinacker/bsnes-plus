...
void PPU::Window::reset() {
  ...
  regs.one_left = random(0);
  regs.one_right = random(0);
  regs.two_left = random(0);
  regs.two_right = random(0);
  ...
  regs.bg1_main_enable = random(0);
  regs.bg1_sub_enable = random(0);
  regs.bg2_main_enable = random(0);
  regs.bg2_sub_enable = random(0);
  regs.bg3_main_enable = random(0);
  regs.bg3_sub_enable = random(0);
  regs.bg4_main_enable = random(0);
  regs.bg4_sub_enable = random(0);
  regs.oam_main_enable = random(0);
  regs.oam_sub_enable = random(0);
